...
//图片缓存技术的核心类
    ...
    public PhotoAdapter(Context context, int i, String[] imageThumbUrls, GridView gv) {
        super(context,i,imageThumbUrls);
        mPhotoView=gv;
