...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e(TAG, "bg:" + drawable + "w:" + drawable.getIntrinsicWidth() + "h:" + drawable.getIntrinsicWidth());
    }
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        ...
        if(hasFocus){
            ...
            ScaleDrawable testScaleBackground = (ScaleDrawable) testScale.getBackground();
            testScaleBackground.setLevel(10);
