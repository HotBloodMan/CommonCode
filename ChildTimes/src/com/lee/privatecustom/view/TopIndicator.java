...
public class TopIndicator extends LinearLayout {
	...
	// �����˵�����������
	//"��",
	private CharSequence[] mLabels = new CharSequence[] {getResources().getString(R.string.erge),
			getResources().getString(R.string.gushi),
			getResources().getString(R.string.donghuapian) };
